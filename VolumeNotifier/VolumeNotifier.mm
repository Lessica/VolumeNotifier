...
#include <substrate.h>
@class VolumeControl; @class SBCCFlashlightSetting; @class MPUMediaControlsVolumeView; @class SBBannerController; @class SBMediaController; 
...
static __inline__ __attribute__((always_inline)) Class _logos_static_class_lookup$SBBannerController(void) { static Class _klass; if(!_klass) { _klass = objc_getClass("SBBannerController"); } return _klass; }static __inline__ __attribute__((always_inline)) Class _logos_static_class_lookup$SBMediaController(void) { static Class _klass; if(!_klass) { _klass = objc_getClass("SBMediaController"); } return _klass; }
